...
import 'package:mango_app/music_screen.dart';
import 'package:mango_app/setting_screen.dart';
import 'package:mango_app/wallpaper_screen.dart';
  ...
  Widget createScreenFor(
    ...
    bool showNavBarExample,
      ...
      switch (screenSelected) {
        ...
        ScreenSelected.color => const WallpaperScreen(),
        ScreenSelected.typography => const MusicScreen(),
        ScreenSelected.elevation => const SettingScreen()
      };

  PreferredSizeWidget createAppBar() {
    return AppBar(title: const Text("Mango"));
  }
