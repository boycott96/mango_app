...
class WallpaperTrending extends StatefulWidget {
  const WallpaperTrending({super.key});

  @override
  State<WallpaperTrending> createState() => _WallpaperTrendingState();
}

class _WallpaperTrendingState extends State<WallpaperTrending>
