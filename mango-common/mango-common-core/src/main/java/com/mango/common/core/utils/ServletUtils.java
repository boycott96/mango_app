package com.mango.common.core.utils;

import com.alibaba.fastjson2.JSON;
import com.mango.common.core.domain.R;
import com.mango.common.core.text.Convert;
...
public class ServletUtils {
    ...
    public static Mono<Void> webFluxResponseWriter(ServerHttpResponse response, Object value) {
        return webFluxResponseWriter(response, HttpStatus.INTERNAL_SERVER_ERROR, value);
    }
    ...
    public static Mono<Void> webFluxResponseWriter(ServerHttpResponse response, String contentType, HttpStatus status, Object value) {
        ...
        R<?> result = R.fail(status.value(), value.toString());
